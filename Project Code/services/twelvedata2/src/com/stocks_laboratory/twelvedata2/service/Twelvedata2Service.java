package com.stocks_laboratory.twelvedata2.service;


import com.stocks_laboratory.twelvedata2.model.*;
import com.stocks_laboratory.twelvedata2.model.RootResponse;
...
public interface Twelvedata2Service {
  ...
  RootResponse invoke(@Param("country") String country, @Param("apikey") String apikey, @Param("exchange") String exchange, @Param("source") String source);
