package com.stocks_laboratory.twelvedata5.service;


import com.stocks_laboratory.twelvedata5.model.*;
import com.stocks_laboratory.twelvedata5.model.RootResponse;
...
public interface Twelvedata5Service {
   ...
   * @return RootResponse
   */
  @RequestLine("GET /logo?symbol={symbol}&apikey={apikey}&source={source}")
  @Headers({
