...
public interface RestServiceVirtualControllerService {
  ...
  RootResponse restServiceVirtualControllerInvoke(@Param("symbol") String symbol, @Param("outputsize") String outputsize, @Param("apikey") String apikey, @Param("interval") String interval, @Param("source") String source);
